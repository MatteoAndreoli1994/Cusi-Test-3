    ...
    <>
        ...
        <DivCarrello display={isFilterVisible ? "block" : "none"} onClick={(e) => e.stopPropagation()}>
          <ContainerFiltri>
            ...
            <FilterButton onClick={() => setshowStoneInfo(!showStoneInfo)}>
              ...
              <FilterSign>{showStoneInfo ? "-" : "+"}</FilterSign>
            </FilterButton>
      ...
      <Container>
        ...
        <DivInfo>
          ...
          <DivDescrizione>
            <GtaRegular>
              Aggiungi un tocco di colore alla tua collezione con questo anello
              con solitario rosa. Rifinito a mano e realizzato con placcatura in
              oro rosa 14k, questo gioiello dalle linee vivaci presenta una
              pietra di zirconia cubica rosa. Abbinalo ad altri gioielli nella
              stessa finitura metallica per un look coordinato oppure gioca con
              tonalità calde e fredde indossandolo con gioielli in argento
              sterling 925.
            </GtaRegular>
          </DivDescrizione>
        </DivInfo>
