...
import ImmagineCollection from "../../assets/urania1.avif"
import ImmagineCollection2 from "../../assets/urania2.avif"
...
const handleOptionClick = (option) => {
  ...
  const [value, setValue] = useState("urania");
  ...
  const uraniaItems = items.filter((item) => {
    ...
    return (
      item.attributes.collection === "Urania" &&
