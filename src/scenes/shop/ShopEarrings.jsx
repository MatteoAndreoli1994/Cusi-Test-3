...
const ShopEarrings = () => {
  ...
  const earringsItems = items.filter((item) => {
    ...
    if (selectedMaterials.length === 0 && selectedCollection.length === 0) {
      return item.attributes.category === "earrings";
    }
  
    // Verifica la categoria, il materiale e la collezione
    return (
      item.attributes.category === "earrings" &&
    ...
    <>
      ...
      <Container>
        ...
        <DivInfo>
          ...
          <DivDescrizione>
            <GtaRegular>
            Twice as nice. From classic studs to modern hoops, our earrings are expertly made with 
the world’s best lab diamonds and exceptional attention to every detail.
            </GtaRegular>
          </DivDescrizione>
        </DivInfo>
